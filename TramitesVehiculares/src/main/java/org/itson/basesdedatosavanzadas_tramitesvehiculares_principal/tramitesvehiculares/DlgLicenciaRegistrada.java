...
public class DlgLicenciaRegistrada extends javax.swing.JDialog {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DlgLicenciaRegistrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgLicenciaRegistrada dialog = new DlgLicenciaRegistrada(new javax.swing.JFrame(), true);
